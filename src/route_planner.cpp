...
bool RoutePlanner::SortDescendingByGAndHValueSum(RouteModel::Node *node_one, RouteModel::Node *node_two) {
...
RouteModel::Node *RoutePlanner::NextNode() {
    std::sort(open_list.begin(), open_list.end(), RoutePlanner::SortDescendingByGAndHValueSum);
...
void RoutePlanner::AStarSearch() {
    ...
    while (!open_list.empty()) {
        bool reached_end_node = current_node->distance(*end_node) == 0;
